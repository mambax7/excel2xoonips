 ...
 */
COLEFS *
cole_mount (const char *filename, COLERRNO *colerrno)
{
	COLEFS * ret;
...
COLEFILE *
cole_fopen (COLEFS *colefilesystem, const char *filename, COLERRNO *colerrno)
{
...
int
cole_locate_filename (COLEFS *colefilesystem, const char *filename,
		      void *info,
		      COLE_LOCATE_ACTION_FUNC *action,
		      COLERRNO *colerrno)
{
